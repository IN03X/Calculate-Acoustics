...
class Boundary:
    ...
    def generate_bnd_source(self):
        ...
        bnd_source[ x_steps//2-x_steps//10 : x_steps//2+x_steps//10 ] = 1
        return bnd_source 
...
class Iterator:
    ...
    def Dufort_Frankel(self, p: Parameters, x: np.ndarray, x_old: np.ndarray, coef: np.ndarray):
        ...
        return x_new[1:x_steps-1]
    def Backward_Euler(self, p: Parameters, x: np.ndarray):
        pass # TODO HPC
...
def main():
    ...
    Iterator_Method = "Dufort_Frankel" # Forward_Euler, Dufort_Frankel, Backward_Euler: 经典显式, Dufort_Frankel显式, 经典隐式
